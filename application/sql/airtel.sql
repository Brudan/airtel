...
INSERT INTO `status` (`id`, `short_desc`, `details`) VALUES
(0, 'No', 'This query hasn''t been serviced.'),
(1, 'Yes', 'This query has been serviced.');
...
ALTER TABLE `response`
  ADD CONSTRAINT `response_ibfk_1` FOREIGN KEY (`query_id`) REFERENCES `query` (`id`) ON DELETE CASCADE;
